 ...
 *
 * Contributing author: Tyler Smith (@mbmufffin), Slightly modified by Peter Viszt (@passatgt)
 * Updated as of Lemur Slider v1.1 - responsive fix by burquidi
 */
(function(a) {
...
jQuery(document).ready(function(c) {
            ...
            start: function(l) {
                ...
                if (h.find(".flickr-slides").length) {
                    ...
                    if (userid) {
                        ...
                        c.getJSON("http://api.flickr.com/services/feeds/photos_public.gne?jsoncallback=?", {
                            id: userid,
                            format: "json"
                        }, function(data) {
                            c.each(data.items, function(i, item) {
                                ...
                                if (linkto) {
                                    if (linkto == 'image') {
                                        slide.append('<a href="' + item.media.m.replace('_m.', '_b.') + '" class="slide-link"></a>');
                                    }
                                    if (linkto == 'flickr') {
                                        slide.append('<a href="http://flic.kr/p/' + item.link + '" class="slide-link"></a>');
                                    }
                                }
                        ...
                        c.getJSON(YQL, function(r) {
                            ...
                            c.each(r.query.results.photo, function(i, value) {
                                ...
                                if (linkto) {
                                    if (linkto == 'image') {
                                        slide.append('<a href="' + imgSrc + '" class="slide-link"></a>');
                                    }
                                    if (linkto == 'flickr') {
                                        slide.append('<a href="http://flic.kr/p/' + base58.encode(parseInt(value.id)) + '" class="slide-link"></a>');
                                    }
                                }
                    ...
                    c.ajax({
                        ...
                        success: function(response) {
                            ...
                            c.each(response.data, function(i, value) {
                                ...
                                if (linkto) {
                                    if (linkto == 'image') {
                                        slide.append('<a href="' + value.images.standard_resolution.url + '" class="slide-link"></a>');
                                    }
                                    if (linkto == 'instagram') {
                                        slide.append('<a href="' + value.link + '" class="slide-link"></a>');
                                    }
                                }
    ...
    //window resize - added 10/29/2014
    c(window).load(function(){
